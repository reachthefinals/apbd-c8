...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps
                .Where(emp => emp.Salary == Emps.Max(emp2 => emp2.Salary));
            return result;
        }
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IEnumerable<Emp> HasUnderling(this IEnumerable<Emp> source, IEnumerable<Emp> allEmps)
        {
            return source.Where(emp => allEmps.Select(ae => ae.Mgr).Contains(emp));
        }
    }
}